...
USER_NAME = os.environ.get('USER_NAME', 'pkpotter03')
...
if __name__ == '__main__':
    """
    Pratik Kumbhar (pkpotter03), adapted from Andrew Grant's README generator.
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 1, 26))
